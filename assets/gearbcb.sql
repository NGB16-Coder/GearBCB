...
-- Thời gian đã tạo: Th4 16, 2025 lúc 12:30 PM
...
(10, 'Ốp lưng iPhone 16 Pro Max', 'assets/img/product/1744781484_op-lung-iphone-16-pro-max-apple-silicone-magsafe_7_.jpg', '', b'1', 43, '2025-04-16 12:31:24', '2025-04-16 12:31:24', b'1', NULL, NULL, NULL, 1250000, 0);
...
--
ALTER TABLE `danh_muc`
  MODIFY `dm_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `san_pham`
  MODIFY `sp_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
